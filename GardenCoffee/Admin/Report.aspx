<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="GardenCoffee.Admin.Report" %>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvFromDate" runat="server" ForeColor="Red" ErrorMessage="*"
                                                    SetFocusOnError="false" Display="Dynamic" ControlToValidate="txtFromDate"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvToDate" runat="server" ForeColor="Red" ErrorMessage="*"
                                                    SetFocusOnError="false" Display="Dynamic" ControlToValidate="txtToDate"></asp:RequiredFieldValidator>
